...
AREAS = {**A, **B}
LABEL = {"S56": "SHIPPED V56", "S54": "SHIPPED V54", "S53": "SHIPPED V53", "N": "NEXT", "D": "DEFERRED", "R": "REJECTED"}
...
out.append("QUADCOM ❖ GENESIS PUBLIC SITE — BUILD 54 UPGRADE CATALOG (UPDATED BUILD 56)\n")
